...
! function(e, t) {
  ...
  I.prototype.global = function global() {
    ...
    var r = this.context[e];
    if (r && r.get() !== _) throw new SyntaxError("Identifier '" + e + "' has already been declared");
  ...
  var Vt = Object.freeze({
    ...
    CallExpression : function CallExpression(e, t) {
      ...
      if ("MemberExpression" === e.callee.type) {
        ...
        if ("function" != typeof s) throw new TypeError(n + " is not a function");
        if (s[mt]) throw new TypeError("Class constructor " + n + " cannot be invoked without 'new'")
      } else {
        ...
        if ("function" != typeof s || "Super" !== e.callee.type && s[mt]) {
          ...
          throw "function" != typeof s ? new TypeError(i + " is not a function") : new TypeError("Class constructor " + i + " cannot be invoked without 'new'")
        }
      }
      ...
      if ("Super" === e.callee.type) {
        if (t.find(dt).get()) throw new ReferenceError("Super constructor may only be called once");
        t.find(dt).set(!0)
      }
    ...
    NewExpression : function NewExpression(e, t) {
      ...
      if (i[ft]) throw new TypeError((i.name || "(intermediate value)") + " is not a constructor");
  ...
  function mr(t, r, i) {
    ...
    return void 0 === i && (i = {}), A(this, function(e) {
      if (a = i.getVar, a = void 0 !== a && a, n = i.throwErr, n = void 0 === n || n, "undefined" !== t.name) {
        if (s = r.find(t.name)) {
          if (a) return [2, s];
          if ((a = s.get()) === _) throw new ReferenceError(t.name + " is not defined");
          return [2, a]
        }
      ...
      return A(this, function(e) {
        switch (e.label) {
          ...
          case 4:
            ...
            if ("function" != typeof o) throw new TypeError(n + " is not a function");
            if (o[mt]) throw new TypeError("Class constructor " + n + " cannot be invoked without 'new'");
            return [3, 7];
          case 5:
          ...
          case 6:
            ...
            if ("function" != typeof o || "Super" !== t.callee.type && o[mt]) {
              ...
              throw "function" != typeof o ? new TypeError(c + " is not a function") : new TypeError("Class constructor " + c + " cannot be invoked without 'new'")
            }
            e.label = 7;
          case 7:
            h = [], u = 0, e.label = 8;
          ...
          case 13:
            if ("Super" === t.callee.type) {
              if (r.find(dt).get()) throw new ReferenceError("Super constructor may only be called once");
              r.find(dt).set(!0)
            }
  ...
  function ri(t, r) {
    var i, n, s, a, o;
    return A(this, function(e) {
      if (n = r.global(), (n = n.find(yt + t.source.value)) && (n = n.get()) && ("function" == typeof n ? i = n() : "object" == typeof n && (i = n)), !i || "object" != typeof i) throw new TypeError('Failed to resolve module specifier "' + t.source.value + '"');
